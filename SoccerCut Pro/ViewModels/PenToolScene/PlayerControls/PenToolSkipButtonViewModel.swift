//
//  PenToolSkipButtonViewModel.swift
//  SoccerCut Pro
//
...
class PenToolSkipButtonViewModel: ObservableObject {
    ...
    func onClick() { player.skip() }
    
    @objc func onChangeRate() { label = player.playingState.skipLabel }
}
